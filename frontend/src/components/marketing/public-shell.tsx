      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-background/90 px-5 py-4 backdrop-blur">
        <nav className="mx-auto flex max-w-6xl items-center justify-between gap-4">
          <Link className="flex items-center gap-2 text-primary" href="/">
            ...
            <span className="font-mono text-sm font-bold uppercase tracking-widest">PhishAware</span>
          </Link>
      ...
      <footer className="border-t border-white/10 px-5 py-8">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 text-sm text-on-surface-variant md:flex-row md:items-center md:justify-between">
          <Link className="flex items-center gap-2 text-primary" href="/">
            ...
            <span className="font-mono font-bold uppercase tracking-widest">PhishAware</span>
          </Link>
          <p>Cybersecurity awareness through safe, AI-powered simulations.</p>
          <p>© 2026 PhishAware</p>
        </div>
      </footer>
    </main>
